...
<template>
  <div class="relative w-full h-fit login">
    ...
    <div class="absolute z-20 w-[450px] py-[3rem] px-[68px] h-fit bg-[rgba(0,0,0,0.7)] inset-0 m-auto">
      <div class="text-[2rem] text-bld text-white pb-[20px]">Sign Up</div>
      <el-form
        ref="formRef"
      ...
      >
        ...
        >
          <el-input placeholder="Email" v-model="dynamicValidateForm.email" />
        </el-form-item>
        <el-form-item
          prop="password"
          :rules="{
        ...
        >
          <el-input placeholder="Password" v-model="dynamicValidateForm.password" type="password" />
        </el-form-item>
        <el-form-item
          ...
          class="bg-[black] text-white pb-4"
        >
          <el-input placeholder="Confirm password" v-model="dynamicValidateForm.confirmPassword" type="password" />
        </el-form-item>
        ...
        <el-form-item class="py-3 w-full text-center">
          <span class="text-[rgba(255,255,255,0.7)]">Already have an account?</span>
          <span class="text-white pl-2 cursor-pointer hover:underline" @click="goToSignin">Sign in</span>
        </el-form-item>
      </el-form>
    </div>
  </div>
